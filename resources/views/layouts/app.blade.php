    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <div class="nav-item"><a href="{{ route('dosen-courses') }}" class="nav-link {{ Route::is('dosen-courses*') || Route::is('dosen-schedule.detail*') ? 'active' : '' }}"><i class="fas fa-play-circle"></i> Buka Sesi Jadwal</a></div>
