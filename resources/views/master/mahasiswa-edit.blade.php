...
<div class="glass-card" style="max-width: 900px; margin: 0 auto;">
    ...
    <form action="{{ route('mahasiswa.update', $mahasiswa) }}" method="POST" style="display:grid; grid-template-columns:repeat(auto-fit,minmax(220px,1fr)); gap:0.75rem;">
        ...
        <div>
            ...
            <input id="nim" type="text" value="{{ $mahasiswa->nim }}" style="width:100%; padding:0.75rem; border:none; background:#E5E7EB; color:#4b5563; border-radius:8px;" disabled>
        </div>
        ...
        <div>
            ...
            <input id="rfid_uid" type="text" value="{{ $mahasiswa->rfid_uid }}" style="width:100%; padding:0.75rem; border:none; background:#E5E7EB; color:#4b5563; border-radius:8px;" disabled>
        </div>

        <div>
            <label for="barcode_id" style="font-size:0.75rem; color:#6b7280; display:block; margin-bottom:0.4rem;">Barcode ID</label>
            <input id="barcode_id" type="text" value="{{ $mahasiswa->barcode_id }}" style="width:100%; padding:0.75rem; border:none; background:#E5E7EB; color:#4b5563; border-radius:8px;" disabled>
        </div>
        ...
        <div>
            ...
            <input id="fingerprint_data" type="text" value="{{ $mahasiswa->fingerprint_data }}" style="width:100%; padding:0.75rem; border:none; background:#E5E7EB; color:#4b5563; border-radius:8px;" disabled>
        </div>
        ...
        <div style="grid-column:1/-1;">
            ...
            <textarea id="face_model_data" style="width:100%; padding:0.75rem; border:none; background:#E5E7EB; color:#4b5563; border-radius:8px; min-height:90px;" disabled>{{ $mahasiswa->face_model_data }}</textarea>
        </div>
