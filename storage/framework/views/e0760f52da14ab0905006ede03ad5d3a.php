...
<?php $__env->startSection('title', 'Mata Kuliah Saya'); ?>
...
<div style="max-width: 1200px; margin: 0 auto;">
    <div class="glass-card" style="margin-bottom: 1.25rem;">
        <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:1rem; flex-wrap:wrap;">
            ...
            <div style="display:flex; gap:0.5rem; flex-wrap:wrap;">
                <a href="<?php echo e(route('reports.index')); ?>" class="btn-kinetic" style="text-decoration:none; padding:0.62rem 0.9rem; font-size:0.82rem; background:#0066CC; box-shadow:none;">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $groupedSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="glass-card" style="margin-bottom: 1rem;">
            <div style="display:flex; justify-content:space-between; align-items:center; gap:1rem; flex-wrap:wrap; margin-bottom:1rem;">
                <div>
                    <h4 class="display-font" style="margin:0; font-size:1.05rem;"><?php echo e($group['semester']); ?></h4>
                    <div style="font-size:0.85rem; color:#6b7280;"><?php echo e(number_format($group['total'])); ?> sesi jadwal terdaftar</div>
                </div>
                ...
                <?php $__currentLoopData = $group['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="border:1px solid #e5e7eb; border-radius:16px; padding:1rem; background:#fff; box-shadow: 0 10px 30px rgba(0,0,0,0.03);">
                        <div style="display:flex; justify-content:space-between; gap:1rem; align-items:flex-start; margin-bottom:0.75rem;">
                            <div>
                                <div style="font-size:0.72rem; font-weight:700; color:#0066CC; text-transform:uppercase; letter-spacing:0.08em;"><?php echo e($jadwal->hari); ?></div>
                                <div style="font-size:1rem; font-weight:800; color:var(--primary-dark); margin-top:0.25rem;"><?php echo e($jadwal->mata_kuliah?->nama_mk ?? '-'); ?></div>
                                <div style="font-size:0.85rem; color:#6b7280; margin-top:0.15rem;"><?php echo e($jadwal->mata_kuliah?->kode_mk ?? '-'); ?> · <?php echo e($jadwal->kelas?->nama_kelas ?? '-'); ?></div>
                            </div>
                            <div style="text-align:right; white-space:nowrap;">
                                <div style="font-size:0.72rem; color:#6b7280; text-transform:uppercase; font-weight:700;">Waktu</div>
                                <div style="font-size:0.95rem; font-weight:700;"><?php echo e(substr($jadwal->jam_mulai, 0, 5)); ?> - <?php echo e(substr($jadwal->jam_selesai, 0, 5)); ?></div>
                            </div>
                        </div>
                        ...
                        <div style="display:flex; gap:0.5rem; flex-wrap:wrap; margin-top:0.9rem;">
                            <a href="<?php echo e(route('dosen-schedule.detail', ['date' => $todayDate, 'mata_kuliah_id' => $jadwal->mata_kuliah_id, 'kelas_id' => $jadwal->kelas_id])); ?>" class="btn-kinetic" style="text-decoration:none; padding:0.55rem 0.8rem; font-size:0.8rem; box-shadow:none;">
                            ...
                            <?php else: ?>
                                <form action="<?php echo e(route('dosen-schedule.start')); ?>" method="POST" style="margin:0;">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="mata_kuliah_id" value="<?php echo e($jadwal->mata_kuliah_id); ?>">
                                    <input type="hidden" name="kelas_id" value="<?php echo e($jadwal->kelas_id); ?>">
                                    <button type="submit" class="btn-kinetic" style="padding:0.55rem 0.8rem; font-size:0.8rem; background:<?php echo e($shouldAutoOpen ? '#F59E0B' : '#F1F5F9'); ?>; color:<?php echo e($shouldAutoOpen ? '#fff' : 'var(--primary-dark)'); ?>; box-shadow:none; border:none; cursor:pointer;">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="glass-card" style="text-align:center; padding:3rem 2rem;">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="btn-kinetic" style="text-decoration:none; padding:0.8rem 1rem; font-size:0.85rem; box-shadow:none;">Kembali ke Dashboard</a>
        </div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\IOT-Attendace\resources\views/dosen/courses.blade.php ENDPATH**/ ?>